    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Baza de date</h2>
                <!-- Icon Divider-->
                ...
                <a class="btn btn-success" type="button" href="searchView.php">Căutare</a>
                ...
                <div class="row justify-content-center">
                    ...
                    <style>
                      ...
                      $sql = "SELECT * FROM liceu";
                      foreach ($dbh->query($sql) as $row){?>
                        <tr>
                        <td><?php print $row['id'];?> </td>
                        <td><?php print $row['clasa'];?> </td>
                        <td><?php print $row['nume'];?> </td>
                        <td><?php print $row['nota'];?> </td>
                        <td><?php print $row['descriere'];?> </td>
                        <td>
                     ...
                     <?php //print $row['id'].'-'.$row['clasa'].'-'. $row['nume'].'-'.$row['nota'].'-'.$row['descriere'].'-'.'<br/>';
                      }
                      $dbh = null;
                      ?>
                    </table>
