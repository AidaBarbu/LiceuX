...
if(!isset($eroare)) {
 ...
 $sql = "UPDATE liceu SET clasa ='$clasa', nume ='$nume', nota ='$nota', 
descriere ='$descriere' WHERE id = '$get_id' ";
 $dbh->exec($sql);
 if($dbh->query($sql) === TRUE) {
 $mesaj = '<h4>Datele au fost adaugate</h4>';
 }
 else $mesaj = '<h4>Datele au fost adaugate </h4>';
}
...
<form action="" method="post">
    ...
    <button name="trimite" href="dateLiceu.php">Trimite</button>
</form>
